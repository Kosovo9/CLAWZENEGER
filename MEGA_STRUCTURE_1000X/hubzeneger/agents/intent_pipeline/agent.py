...
class IntentPipeline(BaseAgent):
    def __init__(self, config=None):
        super().__init__("intent_pipeline", config)
        self.feature_name = "Declared Intent Pipeline"
        ...
        while True:
            try:
                ...
                if task:
                    ...
                    # Lógica específica para Declared Intent Pipeline
