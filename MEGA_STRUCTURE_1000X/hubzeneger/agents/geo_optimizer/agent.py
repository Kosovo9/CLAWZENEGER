...
class GeoOptimizer(BaseAgent):
    def __init__(self, config=None):
        super().__init__("geo_optimizer", config)
        self.feature_name = "Generative Engine Optimization (GEO)"
        ...
        while True:
            try:
                ...
                if task:
                    ...
                    # Lógica específica para Generative Engine Optimization (GEO)
