...
class CausalModels(BaseAgent):
    def __init__(self, config=None):
        super().__init__("causal_models", config)
        self.feature_name = "Causal vs Predictive Modeling"
        ...
        while True:
            try:
                ...
                if task:
                    ...
                    # Lógica específica para Causal vs Predictive Modeling
